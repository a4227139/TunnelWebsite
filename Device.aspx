<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Device.aspx.cs" Inherits="_Default" %>
...
<body>
    <div class="top">
      ...
      <div id="side_here">
        ...
        <div id="here_area" class="path"> 您现在的位置:设备管理>>设备信息
</div>
      </div>
    </div>
  <div class="side">
    ...
    <div class="main">
       <iframe name="right" id="rightMain" src="shebeixingxi.aspx" frameborder="no" scrolling="auto" width="100%" height="auto" allowtransparency="true"></iframe>
    </div>
    <div class="bottom">
