...
<body>
    <div class="top">
      ...
      <div id="side_here">
        ...
        <div id="here_area" class="path"> 您现在的位置:主页
</div>
      </div>
    </div>
      <div class="side">
    ...
    <div class="main">
       <iframe name="right" id="rightMain" src="dingwei.aspx" frameborder="no" scrolling="auto" width="2000" height="300" allowtransparency="true"></iframe>
    </div>
    <div class="bottom">
