<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Manage3.aspx.cs" Inherits="Manage" %>
...
<body>
    <div class="top">
      ...
      <div id="side_here">
        ...
        <div id="here_area" class="path"> 您现在的位置:员工管理>>员工信息概览
</div>
      </div>
    </div>
  <div class="side">
    ...
    <div class="main">
       <iframe name="right" id="rightMain" src="manager3.aspx" frameborder="no" scrolling="auto" width="100%" height="auto" allowtransparency="true"></iframe>
    </div>
    <div class="bottom">
