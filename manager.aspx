    ...
    <div id="search_bar" class="mt10">
       <div class="box">
          <div class="box_border">
            ...
            <div class="box_center pt10 pb10" runat="server" id="div1">
            <tr>
                  <td>&nbsp;按姓名查询</td>
           ...
           <table class="form_table" border="0" cellpadding="0" cellspacing="0" style="text-align: center">
                ...
                <tr>
                  ...
                  <asp:Label ID="Label1" runat="server" ForeColor="Red" Text="注意：（1）查询分按姓名查询和按佩戴节点查询两种，只需输入<br />&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;员工的一种信息便可进行查询<br />&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; （2）该网页中，若要新增、修改或删除员工信息请先输入<br /> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; 相关信息，再点击按钮。<br />&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; （3）清空按钮：将输入在文本框中的相关信息清空。<br />&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; （4）各标题栏可点击进行收缩或展开。"></asp:Label></div>
