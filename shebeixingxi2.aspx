       ...
       <div class="box" >
          <div class="box_border">
           ...
           <table class="form_table" border="0" cellpadding="0" cellspacing="0" style="text-align: center">
                <tr>
                  ...
                  <asp:Label ID="Label1" runat="server" Text="注意：（1）该网页中，若要新增、修改或删除设备信息请先输入<br /> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 相关信息，再点击按钮。<br />&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; （2）清空按钮：将输入在文本框中的相关信息清空。<br />&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; （3）当类型选择为定位基点时，还需输入基点坐标。<br />&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; （4）各标题栏可点击进行收缩或展开。"></asp:Label></div>
        ...
        <div class="box">
          <div class="box_border">
            ...
            <div class="box_center pt10 pb10" runat="server" id="div2" >
                <div class="search_bar_btn" style="text-align:left;">
