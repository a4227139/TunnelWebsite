<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Position.aspx.cs" Inherits="_Default" %>
...
<body>
    <div class="top">
      ...
      <div id="side_here">
        ...
        <div id="here_area" class="path"> 您现在的位置:人员定位>>查看当前定位
</div>
      </div>
    </div>
      <div class="side">
    ...
    <div class="main">
       <iframe name="right" id="rightMain" src="dingwei.aspx" frameborder="no" scrolling="auto" width="100%" height="auto" allowtransparency="true"></iframe>
    </div>
    <div class="bottom">
